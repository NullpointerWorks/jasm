 ...
 * byte 8:		value
 * </pre>
 * Jump if the zero flag has not been set. Sets the instruction pointer(IP) to another address.
 */
public class JumpNotEqual implements Instruction
{
	private final VMInstruction operation = VMInstruction.JNE;
