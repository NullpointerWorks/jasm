 ...
 */
public class Load_RMV implements Instruction
{
	private final VMInstruction operation = VMInstruction.LOAD_RMV;
	...
	public void execute(VirtualMachine vm) 
	{
		...
		if (sel1 == null)
		{
			vm.throwException( VMException.VMEX_BAD_INSTRUCTION, Load_RMV.class );
			return;
		}
		
		Register reg1 = vm.getRegister(sel1);
		vm.setMemory(reg1.getValue(), value);
		regIP.addValue(2);
	}
}
